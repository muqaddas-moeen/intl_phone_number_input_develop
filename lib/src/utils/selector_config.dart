...
class SelectorConfig {
  ...
  /// [setSelectorButtonAsSuffixIcon], this sets/places the selector button inside the [TextField] as a suffixIcon.
  final bool setSelectorButtonAsSuffixIcon;
  ...
  const SelectorConfig({
    ...
    this.setSelectorButtonAsSuffixIcon = false,
    this.leadingPadding,
